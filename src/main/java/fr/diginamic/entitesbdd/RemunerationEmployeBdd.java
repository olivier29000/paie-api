package fr.diginamic.entitesbdd;

public class RemunerationEmployeBdd {
	 ...
	 * @param idGrade
	 */
	public RemunerationEmployeBdd(String matricule, int idEntreprise, int idProfilRemuneration, int idGrade) {
		super();
